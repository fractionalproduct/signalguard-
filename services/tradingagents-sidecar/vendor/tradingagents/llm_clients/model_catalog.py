...
MODEL_OPTIONS: ProviderModeOptions = {
    ...
    # Perplexity: web-grounded Sonar models served over an OpenAI-compatible
    # endpoint (api.perplexity.ai). The sonar-reasoning (non-pro) ID was
    # deprecated; the live-verified IDs are sonar / sonar-pro / sonar-reasoning-pro.
    "perplexity": {
        "quick": [
            ("Sonar - Fast, web-grounded search", "sonar"),
            ("Sonar Reasoning Pro - Reasoning + live search", "sonar-reasoning-pro"),
            ("Custom model ID", "custom"),
        ],
        "deep": [
            ("Sonar Pro - Advanced search, more sources/citations", "sonar-pro"),
            ("Sonar Reasoning Pro - Reasoning + live search", "sonar-reasoning-pro"),
            ("Sonar - Lightweight web-grounded search", "sonar"),
            ("Custom model ID", "custom"),
        ],
    },
