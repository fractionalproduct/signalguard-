...
export interface ProposalRow {
  ...
  /** AI plain-English explanation of the deterministic verdict, generated by a
   * background cron. null until generated (or when no API key is configured).
   * EXPLANATORY ONLY — the deterministic verdict above stays primary. */
